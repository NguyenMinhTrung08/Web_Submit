...
@WebServlet(name = "MultiPartServlet", urlPatterns = { "/admin/videos", "/admin/video/create", "/admin/video/update", "/admin/video/seach",
		"/admin/video/delete"  })
...
public class VideoController extends HttpServlet {
	...
	InterFaceCategoryService cateService = new CategoryServiceImpl();
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		else if (url.contains("seach")) {

			req.getRequestDispatcher("/views/admin/video-seach.jsp").forward(req, resp);
		}
